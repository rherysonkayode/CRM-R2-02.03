...
import {
  ...
  CalendarDays, Calculator, PlusCircle, X
} from "lucide-react";
...
interface AppSidebarProps {
  onClose?: () => void; // função para fechar a sidebar no mobile
}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4 px-5 py-6 border-b border-slate-800/60">
        ...
        {/* Botão de fechar (visível apenas no mobile quando onClose existe) */}
        {onClose && (
          <button
            onClick={onClose}
      ...
      <div className="border-t border-slate-800/60 p-4 space-y-3">
        ...
        {/* Botão de recolher (seta) - visível apenas em telas grandes */}
        <button
